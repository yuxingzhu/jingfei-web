<template>
  <div class="app-container">
      ...
      <div>
        <el-form ref="searchForm" :inline="true" :model="searchForm" class="wrap">
          <el-form-item label="BOM编号：">
            <el-input v-model="searchForm.bomNo" clearable size="small" placeholder="请输入BOM编号" style="width: 150px;margin: 0;" @keyup.enter.native="toQuery" />
          </el-form-item>
          <el-form-item label="BOM名称：">
            <el-input v-model="searchForm.bomName" clearable size="small" placeholder="请输入BOM名称" style="width: 150px;margin: 0;" @keyup.enter.native="toQuery" />
          </el-form-item>
    ...
    >
      ...
      <el-table-column label="BOM编号" width="190">
        <template slot-scope="scope">
          <span>{{ scope.row.createTime ? scope.row.createTime : "--" }}</span>
        </template>
      </el-table-column>
      <el-table-column label="BOM名称" width="190">
        <template slot-scope="scope">
          <span>{{
