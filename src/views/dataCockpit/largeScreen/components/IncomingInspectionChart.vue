<template>
  <div class="chart-wrapper">
    <div class="title">
      <div class="title-left">来料质检</div>
      <div class="title-right">
        <span>
          当日来料合计:{{
            (incomingInspectionData.total !== '' || incomingInspectionData.total !== null || incomingInspectionData.total !== undefined) ? regexHandleNum(incomingInspectionData.total) : "--"
          }}
        </span>
        <span> 正品率:{{ (incomingInspectionData.authenticityRate !== '' || incomingInspectionData.authenticityRate !== null || incomingInspectionData.authenticityRate !== undefined) ? incomingInspectionData.authenticityRate.toFixed(1) + "%" : "--" }} </span>
      </div>
    </div>
    <div class="content">
...
export default {
  ...
  mounted() {
    this.getChart(this.incomingInspectionData)
  ...
  methods: {
    getChart(incomingInspectionData) {
      const that = this
      ...
      const option = {
        ...
        xAxis: {
          ...
          data: incomingInspectionData.xAxisData
        },
        yAxis: {
          type: 'value',
          axisLabel: {
        ...
        series: [
          {
            ...
            z: -16,
            data: incomingInspectionData.authenticQuantityList,
            label: {
              normal: {
                show: false,
                position: 'top',
          ...
          },
          {
            ...
            symbolPosition: 'start',
            z: -16,
            data: incomingInspectionData.rejectNumList,
            label: {
              normal: {
                show: false,
                position: 'top',
