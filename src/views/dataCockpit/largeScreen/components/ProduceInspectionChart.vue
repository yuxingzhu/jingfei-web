  ...
  <div class="chart-wrapper">
    <div class="title">
      ...
      <div class="title-right">
        <span>
          当日合计生产:{{ (produceInspectionData.total !== '' || produceInspectionData.total !== null || produceInspectionData.total !== undefined) ? regexHandleNum(produceInspectionData.total) : "--" }}
        </span>
        <span>
          正品率:{{ (produceInspectionData.authenticityRate !== '' || produceInspectionData.authenticityRate !== null || produceInspectionData.authenticityRate !== undefined) ? produceInspectionData.authenticityRate.toFixed(1) + "%" : "--" }}
        </span>
      </div>
    </div>
    <div class="content">
...
export default {
  ...
  mounted() {
    this.getChart(this.produceInspectionData)
  ...
  methods: {
    getChart(produceInspectionData) {
      const that = this
      ...
      const option = {
        ...
        xAxis: {
          ...
          data: produceInspectionData.xAxisData
        },
        yAxis: {
          type: 'value',
          axisLabel: {
        ...
        series: [
          {
            ...
            z: -16,
            data: produceInspectionData.authenticQuantityList,
            label: {
              normal: {
                show: false,
                position: 'top',
          ...
          },
          {
            ...
            symbolPosition: 'start',
            z: -16,
            data: produceInspectionData.rejectNumList,
            label: {
              normal: {
                show: false,
                position: 'top',
