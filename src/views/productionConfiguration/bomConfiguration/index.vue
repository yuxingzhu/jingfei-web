<template>
  <div class="app-container">
      ...
      <div>
        <el-form ref="searchForm" :inline="true" :model="searchForm" class="wrap">
          <el-form-item label="BOM编号：">
            <el-input v-model="searchForm.bomNo" clearable size="mini" placeholder="请输入BOM编号" style="width: 150px;margin: 0;" @keyup.enter.native="toQuery" />
          </el-form-item>
          <el-form-item label="BOM名称：">
            <el-input v-model="searchForm.bomName" clearable size="mini" placeholder="请输入BOM名称" style="width: 150px;margin: 0;" @keyup.enter.native="toQuery" />
          </el-form-item>
    ...
    >
      ...
      <el-table-column label="BOM编号" width="100">
        <template slot-scope="scope">
          <span>{{ scope.row.bomNo ? scope.row.bomNo : "--" }}</span>
        </template>
      </el-table-column>
      <el-table-column label="BOM名称" width="100">
        <template slot-scope="scope">
          <span>{{ scope.row.bomName ? scope.row.bomName : "--" }}</span>
        </template>
      </el-table-column>
      ...
      <el-table-column label="是否为主料" width="100">
        <template slot-scope="scope">
          <span>{{
            scope.row.isIngredients ? scope.row.isIngredients : "--"
          }}</span>
        </template>
      </el-table-column>
      <el-table-column label="物料编号" width="110">
        <template slot-scope="scope">
