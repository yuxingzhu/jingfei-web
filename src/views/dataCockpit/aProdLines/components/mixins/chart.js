...
const getPie3D = (pieData, internalDiameterRatio, distance, alpha, pieHeight, opacity = 1) => {
  ...
  for (let i = 0; i < series.length; i++) {
    ...
    series[i].pieData.endRatio = endValue / sumValue || 0
      ...
      formatter: params => {
        if (
          params.seriesName !== 'mouseoutSeries' &&
            params.seriesName !== 'pie2d' && option.series[params.seriesIndex].pieData && option.series[params.seriesIndex].pieData.endRatio && option.series[params.seriesIndex].pieData.startRatio
        ) {
          const bfb = (
