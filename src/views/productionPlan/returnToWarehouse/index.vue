<template>
  <div class="app-container">
      ...
      <div>
        <el-form ref="searchForm" :inline="true" :model="searchForm" class="wrap">
          <el-form-item label="入库编号">
            <el-input v-model="searchForm.putInNo" clearable size="mini" placeholder="请输入库编号" style="width: 150px;margin: 0;" @keyup.enter.native="toQuery" />
          </el-form-item>
    ...
    >
      ...
      <el-table-column label="关联生产工单" width="140">
        <template slot-scope="scope">
          <span>{{
      ...
      <el-table-column label="型号" width="100" :show-overflow-tooltip="true">
        <template slot-scope="scope">
          <span>{{
      ...
      <el-table-column label="规格" :show-overflow-tooltip="true" width="100">
        <template slot-scope="scope">
          <span>{{
      ...
      <el-table-column label="仓库位置" :show-overflow-tooltip="true" width="100">
        <template slot-scope="scope">
          <span>{{
...
import {
  productionInOutUpload,
  productionInOutQuery
} from '@/api/productionPlan/returnToWarehouse'
export default {
  ...
  methods: {
    ...
    uploadFile(params) {
      ...
      productionInOutUpload(file).then(res => {
    ...
    productionInOutQuery() {
      this.loading = true
      productionInOutQuery({ ...this.searchForm, page: this.pageOptions.page, size: this.pageOptions.size }).then(res => {
